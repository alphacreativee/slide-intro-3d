...
function initializesliderForLargeScreens() {
  ...
  // Nếu có relative-block thì set chiều cao
  if (relativeBlock) {
  ...
  // Thêm class để phân biệt slide trái/phải
  reviewSlides.forEach((slide, index) => {
    if (index % 2 === 0) {
...
window.addEventListener("resize", function () {
  if (window.innerWidth >= 768) {
    ...
    // Nếu resize về màn hình nhỏ -> xóa bỏ event listener
